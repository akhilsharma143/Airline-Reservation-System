...
if (isset($_POST['Submit'])) {
    ...
    if (empty($data_missing)) {
        ...
        $query = "INSERT INTO admin (username, name, password, email) VALUES (?, ?, ?, ?)";
        $stmt = $conn->prepare($query);
        mysqli_stmt_bind_param($stmt, "ssss", $user_name, $name, $hashed_password, $email_id);
        mysqli_stmt_execute($stmt);

        $affected_rows = mysqli_stmt_affected_rows($stmt);

        if ($affected_rows == 1) {
            echo "<br> <br> <br> <br> <b>New Admin successfully registered!<b>";
        } else {
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6 mt-5 ">
                ...
                <form action="new_admin.php" method="POST" id="new_admin_form">
                    <h2><i class="fa fa-user-plus" aria-hidden="true"></i> CREATE NEW ADMIN ACCOUNT</h2>
