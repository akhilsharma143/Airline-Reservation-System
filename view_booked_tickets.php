...
<nav class="navbar navbar-expand-lg fixed-top">
    <div class="container">
		...
		<?php
			...
			$query = "SELECT pnr, date_of_reservation, flight_no, journey_date, class, booking_status, no_of_passengers FROM ticket_details WHERE customer_id=? AND journey_date<? AND journey_date>=? ORDER BY journey_date";
$stmt = mysqli_prepare($conn, $query);
mysqli_stmt_bind_param($stmt, "sss", $customer_id, $todays_date, $thirty_days_before_date);
mysqli_stmt_execute($stmt);
mysqli_stmt_bind_result($stmt, $pnr, $date_of_reservation, $flight_no, $journey_date, $class, $booking_status, $no_of_passengers);
