...
<nav class="navbar navbar-expand-lg fixed-top">
    ...
    <div class="customer">
        <a href="book_tickets.php">
            <i class="fa fa-plane" aria-hidden="true"></i> Book Flight Tickets
        </a>
    </div>
    <div class="customer">
        <a href="view_booked_tickets.php">
            <i class="fa fa-plane" aria-hidden="true"></i>View Booked Flight Tickets
        </a>
    </div>
    <div class="customer">
        <a href="cancel_booked_tickets.php">
            <i class="fa fa-plane" aria-hidden="true"></i> Cancel Booked Flight Tickets
        </a>
    </div>
