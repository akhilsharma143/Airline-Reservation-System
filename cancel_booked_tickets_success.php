...
<nav class="navbar navbar-expand-lg fixed-top">
    <div class="container">
        ...
        <div class="container">
            <a href="#" class="navbar-brand"><img src="images/logo.png" id="logo" alt=""> ROYAL AIRWAYS</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="registerDropdown">
                            <a class="dropdown-item" href="new_admin.php?type=custom">Register as Admin</a>
                            <a class="dropdown-item" href="new_user.php?type=passenger">Register as Passenger</a>
                        </div>
                    </li>

                    <li class="nav-item">
                        <a href="login.php" class="nav-link">Book Flights <i class="fas fa-user"></i></a>
                    </li>
                </ul>
            </div>
        </div>
