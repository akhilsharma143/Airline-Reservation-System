...
.adminform {
    max-width: 500px;
    margin: 50px auto;
    background-color: rgba(6, 14, 30, 0.5);
    border-radius: 8px;
    padding: 20px;
...
<nav class="navbar navbar-expand-lg fixed-top">
    <div class="container">
		...
		<h2 style="margin-top:80px">Welcome <?php echo  ucwords($_SESSION['name']);?></h2>

		<form class="adminform">
    <div class="admin">
        <a href="admin_view_booked_tickets.php">
            <i class="fa fa-plane" aria-hidden="true"></i> View List of Booked Tickets for a Flight
        </a>
    </div>
    <div class="admin">
        <a href="add_flight_details.php">
            <i class="fa fa-plane" aria-hidden="true"></i> Add Flight Schedule Details
        </a>
    </div>
    <div class="admin">
        <a href="modify_flight_details.php">
            <i class="fa fa-plane" aria-hidden="true"></i> Modify Flight Schedule Details
        </a>
    </div>
    <div class="admin">
        <a href="delete_flight_details.php">
            <i class="fa fa-plane" aria-hidden="true"></i> Delete Flight Schedule Details
        </a>
    </div>
