...
<nav class="navbar navbar-expand-lg fixed-top">
    <div class="container">
		...
		<form action="AvailableFlights.php" method="post">
			...
			<label for="origin"><strong>Enter the Origin</strong></label>
    <select name="origin">
    ...
    <label for="destination"><strong>Enter the Destination</strong></label>
	...
	<label for="dep_date"><strong>Enter the Departure Date:</strong></label>
            <input type="date" id="dep_date" name="dep_date" class="form-control" required>	

			<label for="passengers"><strong>Enter the No. of Passengers</strong></label>
		<input type="number" id="psngr" name="psngr" class="form-control" required>
				
		<label for="class"><strong>Enter the Class</strong></label>
